...
public class VariableParser extends StatementParser {
	...
	private static final EnumSet<CTokenType> SUBSCRIPT_FIELD_START_SET = EnumSet.of(LEFT_BRACKET);
	...
	public ICodeNode parse(Token token, SymTabEntry variableId)
		...
		if (!((defnCode == VARIABLE) || (defnCode == VALUE_PARM) || (isFunctionTarget && (defnCode == FUNCTION)))) {
	...
	private static final EnumSet<CTokenType> RIGHT_BRACKET_SET = EnumSet.of(RIGHT_BRACKET, SINGLE_EQUALS, SEMICOLON);
