 ...
 *
 * <p>Parse a C array type specification.</p>
 *
...
class ArrayTypeParser extends TypeSpecificationParser
{
     ...
     */
    protected ArrayTypeParser(CParserTD parent)
    {
        super(parent);
    }

    // Synchronization set for the [ token.
    private static final EnumSet<CTokenType> LEFT_BRACKET_SET =
    ...
    private static final EnumSet<CTokenType> OF_SET =
    ...
    /**
     * Parse a C array type specification.
    ...
    private static final EnumSet<CTokenType> INDEX_START_SET =
        SimpleTypeParser.SIMPLE_TYPE_START_SET.clone();
    static {
    ...
    private static final EnumSet<CTokenType> INDEX_END_SET =
        EnumSet.of(RIGHT_BRACKET, OF, SEMICOLON);

    // Synchronization set to follow an index type.
    private static final EnumSet<CTokenType> INDEX_FOLLOW_SET =
