 ...
 *
 * <p>Parse a C enumeration type specification.</p>
 *
...
public class EnumerationTypeParser extends TypeSpecificationParser
{
    ...
    private static final EnumSet<CTokenType> ENUM_CONSTANT_START_SET =
        EnumSet.of(IDENTIFIER, COMMA);

    // Synchronization set to follow an enumeration definition.
    private static final EnumSet<CTokenType> ENUM_DEFINITION_FOLLOW_SET =
    ...
    /**
     * Parse a C enumeration type specification.
