...
public class ExpressionParser extends StatementParser {
	...
	private static final EnumSet<CTokenType> REL_OPS = EnumSet.of(DOUBLE_EQUALS, NOT_EQUALS, LESS_THAN, LESS_EQUALS, GREATER_THAN, GREATER_EQUALS);

	// map relational operator tokens to node types
	private static final HashMap<CTokenType, ICodeNodeType> REL_OPS_MAP = new HashMap<CTokenType, ICodeNodeType>();
	static {
	...
	private static final EnumSet<CTokenType> ADD_OPS = EnumSet.of(PLUS, MINUS,
			CTokenType.OR);

	// Map additive operator tokens to node types.
	private static final HashMap<CTokenType, ICodeNodeTypeImpl> ADD_OPS_OPS_MAP = new HashMap<CTokenType, ICodeNodeTypeImpl>();
	static {
